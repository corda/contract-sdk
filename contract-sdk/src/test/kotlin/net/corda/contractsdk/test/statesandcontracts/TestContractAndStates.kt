...
import net.corda.contractsdk.verifiers.StateWithRoles
import net.corda.contractsdk.verifiers.StateWithStatus
...
class TestContract : StandardContract(), Contract {
    ...
    companion object {
        val ID = "net.corda.contractsdk.test.statesandcontracts.TestContract"
    }
}
